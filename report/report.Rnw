...
load('~/pandoc-test/Stat159/stat159-fall2016-project3/data/multiple-linear-reg.RData')
library(xtable)
@
...
<<loaddata,echo=F>>=
load("~/pandoc-test/stat159/stat159-fall2016-project3/data/rigde-reg.RData")
load("~/pandoc-test/stat159/stat159-fall2016-project3/data/rigde1-reg.RData")
load("~/pandoc-test/stat159/stat159-fall2016-project3/data/rigde2-reg.RData")
@
<<MSE, echo=F, results=tex>>=
...
<<coef, echo=F, results=tex>>=
#coef <- c(coeff_ridge, coeff_ridge2, coeff__ridge1)
#coef <- as.data.frame(coeff_ridge,coeff_ridge2, coeff_ridge1)
#print(xtable(coef, digits=7), include.rownames=F)
@
...
<<loadRFdata, echo=F>>=
load("~/pandoc-test/stat159/stat159-fall2016-project3/data/random-forest-low.RData")
load("~/pandoc-test/stat159/stat159-fall2016-project3/data/random-forest-mid.RData")
load("~/pandoc-test/stat159/stat159-fall2016-project3/data/random-forest-top.RData")
@
