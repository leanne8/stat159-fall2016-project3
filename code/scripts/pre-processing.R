...
topSAT <- data12_13[which(data12_13$SATMT75 > 730 & data12_13$SATMT75 <= 800),]
topACT1 <- data12_13[which(data12_13$ACTMT75 > 31 & data12_13$ACTMT75 <= 34),]
topACT2 <- data12_13[which(data12_13$ACTMT75 > 34 & data12_13$ACTMT75 <= 36),]
