...
##Ridge regression coefficients and MSE
#### coefficients
```{r}
coeff_ridge
```
...
## Results 
Provide a recommendation of schools to pick from in terms of specific skills. 
We recommend choosing schools from our top school data set for the smallest admission rate, and highest SAT scores, ACT scores and graduation rate with respect to each skill.  

## California has the most top schools
![](../images/college-frequency.png)

#### California has most of the largest top STEM programs, vaguely followed by Texas and New York.  

##Biology schools 
![](../images/biggestBio.png)
