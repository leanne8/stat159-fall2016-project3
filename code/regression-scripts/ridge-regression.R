...
topSchools_subset <- topSchools[c('SATMT75', 'ACTMT75', 'ADM_RATE', 'COMP_ORIG_YR4_RT', 'PELL_COMP_ORIG_YR6_RT','MN_EARN_WNE_INC3_P10')]
...
trainset_subset <- trainset[c('SATMT75', 'ACTMT75', 'ADM_RATE', 'COMP_ORIG_YR4_RT', 'PELL_COMP_ORIG_YR6_RT','MN_EARN_WNE_INC3_P10')]
...
testset_subset <- trainset[c('SATMT75', 'ACTMT75', 'ADM_RATE', 'COMP_ORIG_YR4_RT', 'PELL_COMP_ORIG_YR6_RT','MN_EARN_WNE_INC3_P10')]
...
save(cv.out, coeff_ridge, bestlambda, full_mse_ridge, ridgecor, ridge_full, file='data/rigde-reg.RData')
